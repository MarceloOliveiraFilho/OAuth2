...
public class CallbackController {
    ...
    public String callBackFromOAuth(@RequestParam("code") String authCode,  @RequestParam(value = "realmId", required = false) String realmId, HttpSession session) {
...
//        HttpPost post = new HttpPost(oAuth2Configuration.getIntuitBearerTokenEndpoint());
        HttpPost post = new HttpPost("https://api.rd.services/auth/token");
