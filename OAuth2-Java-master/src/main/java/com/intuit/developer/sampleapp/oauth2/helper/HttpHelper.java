...
public class HttpHelper {
	...
	public List<NameValuePair> getUrlParameters(HttpSession session, String action) {
        ...
        if (action == "revoke") {
            ...
            urlParameters.add(new BasicNameValuePair("client_id", "8159bc58-83c2-470b-8f11-9e6b8d2ad12c"));
			urlParameters.add(new BasicNameValuePair("client_secret", "2412b22447f341ebbe9f624ac89f86c5"));
